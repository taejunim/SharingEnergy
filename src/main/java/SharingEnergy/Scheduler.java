...
//            map.add("str", "thisistest");
            ...
            OutsideDataObject outsideDataObject = new OutsideDataObject();
            outsideDataObject.setDeviceId("GS00003201");
            outsideDataObject.setDeviceGbnCd("005");
            outsideDataObject.setOrgGbnCd("002");
            outsideDataObject.setOrgCd("0020001");
            ...
            // REST API 호출
            ResponseObject responseObject = restTemplate.postForObject("http://172.30.1.34:8080/SharingEnergy/checkLatestData.do", outsideDataObject, ResponseObject.class);
